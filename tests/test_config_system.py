...
class TestProviderConfiguration:
    ...
    def test_basic_provider_config(self, temp_config_file):
        ...
        config_data = {
            'defaults': {
                ...
                'provider_api_keys': {
                    'my-custom-openai': 'sk-custom-key'
                }
            },
            'features': {
                'test': {
        ...
        assert resolved.providers['my-custom-openai'].api_base == 'https://custom.example.com/v1'
    ...
    def test_provider_merging(self, temp_config_file):
        ...
        assert resolved.providers['provider-b'].api_base == 'https://b-override.example.com/v1'
    ...
    def test_provider_env_var_resolution(self, temp_config_file):
        ...
        with patch.dict(os.environ, env_vars):
            ...
            assert resolved.providers['my-provider'].api_base == 'https://resolved.example.com/v1'
...
class TestProviderResolution:
    ...
    def test_custom_provider_resolution(self):
        ...
        assert resolved.api_key_lookup == 'my-custom-openai'  # Uses custom name for API key
...
class TestProviderConfigIntegration:
    ...
    def mock_llm_completion(self):
        ...
        with patch('sllmp.pipeline.any_llm.acompletion', side_effect=mock_acompletion) as mock:
    ...
    async def configured_client(self, temp_config_file, mock_llm_completion):
        ...
        config_data = {
            'defaults': {
                ...
                'provider_api_keys': {
                    'my-custom-openai': 'sk-custom-key-123'
                }
            },
            'features': {
                'default': {
    ...
    async def test_custom_provider_with_feature_override(self, temp_config_file, mock_llm_completion):
    ...
    async def test_standard_provider_no_extra_options(self, temp_config_file, mock_llm_completion):
    ...
    async def test_multiple_custom_providers(self, temp_config_file, mock_llm_completion):
...
class TestRetryIntegration:
    ...
    async def test_retry_on_network_error_then_success(
        ...
        mock_llm_completion_with_failures.failure_exception[0] = Exception("Connection timeout")
